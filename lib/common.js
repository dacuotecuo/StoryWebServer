 ...
 */
exports.decrypt = function (data, key, iv, type) {

	if (type == 1) return de_blowfish.apply(null, arguments);
 ...
 * @param type
 */
exports.encrypt = function (data, key, iv, type) {

	if (type == 1) return en_blowfish.apply(null, arguments);
